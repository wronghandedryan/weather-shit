const APIKey = "dd64094a38cd7b5b71bdfc480af823f5";
...
function buildCurrentWeather(data){
    ...
    if(data != null){
        ...
        let UVqueryURL = "https://api.openweathermap.org/data/2.5/uvi?appid="+APIKey+"&lat="+data.coords.lat+"&lon="+data.coord.lon;
